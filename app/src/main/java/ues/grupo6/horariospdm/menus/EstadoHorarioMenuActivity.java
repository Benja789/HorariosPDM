...
/** @noinspection ALL*/
public class EstadoHorarioMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[] activities={"EstadoHorarioInsertarActivity","EstadoHorarioEliminarActivity","EstadoHorarioConsultarActivity",
            "EstadoHorarioActualizarActivity"};

    String entidad = "estado_horario";
    @Override
