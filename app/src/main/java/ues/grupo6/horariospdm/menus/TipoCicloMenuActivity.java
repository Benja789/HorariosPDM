...
/** @noinspection ALL*/
public class TipoCicloMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[] activities={"TipoCicloInsertarActivity","TipoCicloEliminarActivity","TipoCicloConsultarActivity",
            "TipoCicloActualizarActivity"};

    String entidad = "tipo_ciclo";
    @Override
